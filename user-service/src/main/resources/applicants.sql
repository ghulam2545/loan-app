...
INSERT INTO applicants (id, user_role, status, created_at, updated_at, first_name, last_name, email, password, verification_code, code_expiration)
...
INSERT INTO applicants (id, user_role, status, created_at, updated_at, first_name, last_name, email, password, verification_code, code_expiration)
VALUES ('3', 'ADMIN', FALSE, '2025-06-26', '2025-06-28', 'Carol', 'Williams', 'carol@example.com', 'pass789', 'GHI789', '2025-07-05');
