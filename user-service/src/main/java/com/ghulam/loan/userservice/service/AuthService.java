package com.ghulam.loan.userservice.service;
...
import com.ghulam.loan.userservice.repo.ApplicantRepo;
import com.ghulam.loan.userservice.security.TokenService;
import com.ghulam.loan.userservice.utils.CommonUtils;
...
public class AuthService {
    ...
    public Map<String, Object> login(LoginDto loginDto) {
        ...
        return Map.of(
                ...
                "role", applicant.getUserRole().toString(),
                "token", token
        );
    }
    ...
    private Applicant getApplicant(SignupDto signupDto) {
        ...
        applicant.setUserRole(UserRole.APPLICANT);
